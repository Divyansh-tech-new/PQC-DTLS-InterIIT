...
struct WOLFSSL_CTX {
    ...
    defined(WOLFSSL_HAHELPER) || defined(HAVE_LIGHTY) || defined(WOLFSSL_QUIC))
...
#if defined(OPENSSL_ALL) || defined(WOLFSSL_HAHELPER) || defined(WOLFSSL_WPAS)
...
struct WOLFSSL {
    ...
    TLSX* extensions;                  /* RFC 6066 TLS Extensions data */
        ...
        word16 alpn_peer_requested_length; /* number of bytes total */
            ...
            defined(WOLFSSL_HAHELPER) || defined(WOLFSSL_QUIC)
            CallbackALPNSelect alpnSelect;
            void*              alpnSelectArg;
        #endif
...
typedef struct CipherSuiteInfo {
    ...
    defined(WOLFSSL_HAHELPER) || defined(WOLFSSL_NGINX)
    byte minor;
    byte major;
#endif
    byte flags;
