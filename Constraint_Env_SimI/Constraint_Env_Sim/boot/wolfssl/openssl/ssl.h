...
#if defined(WOLFSSL_NGINX) || defined(WOLFSSL_HAHELPER) || \
...
#endif /* WOLFSSL_NGINX || WOLFSSL_HAHELPER || \
...
#if defined(OPENSSL_ALL) || defined(WOLFSSL_HAHELPER)
...
#endif /* OPENSSL_ALL || WOLFSSL_HAHELPER */
...
#define SSL_CTX_set_app_data(ctx,arg)   wolfSSL_CTX_set_ex_data(ctx,0, \
                                                                  (char *)(arg))
#endif /* OPENSSL_ALL || WOLFSSL_ASIO || WOLFSSL_HAHELPER */
...
#define OPENSSL_INIT_set_config_appname  wolfSSL_OPENSSL_INIT_set_config_appname
    ...
    defined(WOLFSSL_HAHELPER) || defined(OPENSSL_EXTRA) || defined(OPENSSL_ALL)
...
#define SSL_R_HTTPS_HELPER_REQUEST                  PARSE_ERROR
...
#endif /* WOLFSSL_NGINX || WOLFSSL_HAHELPER || WOLFSSL_MYSQL_COMPATIBLE ||
 ...
 * used by QUIC implementations, such as HAHelper
 */
...
/* TODO: we do not have this in our QUIC api and HAHelper does not use it
